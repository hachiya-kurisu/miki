...
```
$ pkg_add -D unsigned https://blekksprut.net/pkg/miki
$ rcctl enable miki
$ rcctl start miki
```
...
stay awake with -c.
let miki know where you're at with -l <latitude> and -m <longitude>.
...
* miki listens on [::1]:1900 unless told otherwise
